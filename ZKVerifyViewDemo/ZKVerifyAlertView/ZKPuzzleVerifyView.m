...
- (void)setStyle:(ZKPuzzleVerifyStyle)style
{
    ...
    if (style == ZKPuzzleVerifyStyleCustom) return;
...
- (void)setPuzzlePath:(UIBezierPath *)puzzlePath
{
    ...
    if (_style != ZKPuzzleVerifyStyleCustom) return;
...
- (UIBezierPath *)classicPuzzlePath
{
    ...
    dispatch_once(&onceToken, ^{
        classicPath = [UIBezierPath bezierPathWithPathMaker:^(ZKPuzzlePathMaker * _Nonnull maker) {
